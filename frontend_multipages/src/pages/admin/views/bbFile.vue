    ...
    <el-card class="file_upload_container">
      <el-form :model="state.fileParams" :rules="state.rules" ref="fileRef" label-width="100px" class="fileParams">
        ...
        <el-form-item label="文件">
          <a v-if="state.fileParams.file_path" :href="state.fileParams.file_path" :download="state.fileParams.filename" class="file-downloader">文件下载</a>
...
const handleUrlSuccess = (val) => {  //返回的value，文件路径
